...
public class ProxyParser {
    ...
    public ProxyParser() {
        ...
        exchangeFile = tmpDir + "/pysonar2." + nextSessionId();
        endMark = tmpDir + "/pysonar2." + nextSessionId();
    ...
    public Process startPython(String pythonExe) {
        try {
            ...
            String cmdFile = jsonize.getPath();

            ProcessBuilder builder = new ProcessBuilder(pythonExe, "-i", cmdFile);
